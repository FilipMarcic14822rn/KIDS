...
public class BasicMessage implements Message {
	...
	public String toString() {
		return "[" + ChordState.chordHash(getSenderIpAddress() + ":" + getSenderPort()) + "|" + getSenderPort() + "|" + getMessageId() + "|" +
					getMessageText() + "|" + getMessageType() + "|" +
					getReceiverPort() + "|" + ChordState.chordHash(getReceiverIpAddress() + ":" +getReceiverPort()) + "]";
	}
