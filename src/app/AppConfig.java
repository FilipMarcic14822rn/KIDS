...
public class AppConfig {
	...
	public static void readConfig(String configName, int serventId) {
		...
		try{
			softLimit = Integer.parseInt(properties.getProperty("soft_limit"));
		}catch (NumberFormatException e){
			timestampedErrorPrint("Problem reading soft_limit. Exiting...");
			System.exit(0);
		}

		try{
			hardLimit = Integer.parseInt(properties.getProperty("hard_limit"));
		}catch (NumberFormatException e){
